...
def train(args):
    ...
    DL = get_dataloader(fixed=False, batch_size=5)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--name",      type=str, default="base2", help="name of the experiment")
    ...
    parser.add_argument("--frequency", type=int, default=1000,   help="frequency to output result")
